...
public class BoardVO {
	...
	public BoardVO(String title, int price, String made_by, String category, String description, String writer, String image_file) {
		this.title = title;
		this.price = price;
	...
	// modify : bno, title, price, made_by, category -> mod_at 수정시간으로 변경
	public BoardVO(long bno, String title, int price, String made_by, String category) {
		this.bno = bno;
		this.title = title;
		this.price = price;
		this.made_by = made_by;
